...
CREATE TABLE `t_appointment` (
  ...
  `messageType` varchar(20) NOT NULL COMMENT '咨询类型',
  `status` varchar(20) NOT NULL COMMENT '预约状态',
  `doctorName` varchar(10) DEFAULT NULL COMMENT '预约医生姓名',
  `appointDate` date DEFAULT NULL COMMENT '约定时间',
  `dentalProject` varchar(15) DEFAULT NULL,
  `searchCode` varchar(15) DEFAULT NULL COMMENT '查询码',
...
-- ----------------------------
INSERT INTO `t_appointment` VALUES ('1', '张三', '13313131313', 'CLINIC_YM', 'LEAVE_MSG_YUYUE', 'LEAVE_MSG_YUYUE', 'APPOINT_DOWN', '邓医生', '2018-09-04', 'DENTAL_CHILD', null, '', '5', '2018-09-18 13:42:50', '2018-10-24 22:00:36');
INSERT INTO `t_appointment` VALUES ('2', '李四', '13513131313', 'CLINIC_LL', '111111111111', 'LEAVE_MSG_ZIXUN', 'APPOINT_DOWN', '邓医生', '2018-09-26', '-确认项目类型-', null, '您好，根据您的症状可能是牙周发炎导致的，建议您到我们门诊进行进一步的科学的检查.', '1', '2018-09-03 17:20:48', '2018-10-19 20:37:30');
INSERT INTO `t_appointment` VALUES ('3', '邓兰', '15517304576', 'CLINIC_YM', '一般种植牙的收费情况是？', 'LEAVE_MSG_ZIXUN', 'APPOINT_DOWN', null, null, 'DENTAL_ZZ', null, '您好，种植牙单颗收费5千起，具体需要看种植难易程度而定，欢迎您到门诊进行进一步的检查。', '1', '2018-10-19 23:25:33', '2018-10-19 23:29:46');
INSERT INTO `t_appointment` VALUES ('4', '66611', '13312345678', 'CLINIC_YM', '232323232', 'LEAVE_MSG_ZIXUN', 'APPOINT_DOWN', null, null, 'DENTAL_CHILD', null, '222222222222222222222222222222222222222222222222222222222', '1', '2018-10-28 14:02:34', '2018-10-28 14:03:20');
...
CREATE TABLE `t_article` (
  ...
  `top` int(1) NOT NULL COMMENT '是否置顶(1：置顶 0：不置顶)',
  `status` varchar(255) NOT NULL COMMENT '文章状态(1：启用 0：禁用)',
...
-- ----------------------------
INSERT INTO `t_article` VALUES ('18', '王申：“80后”种植牙医，带着“死磕”精神热血前行', '种植牙', 'ARTICLE_NEWS', '2018-10-14 21:05:06', '如今再提起“80后”，大多数人印象里还是那群热血沸腾的青年人。当“90后”占据舆论，“00后”初露锋芒，“80后”这个曾经站在风口浪尖上的群体，早已沉淀成熟，低调的在各行各业发光发热，成为社会的中流砥柱，成为行业的精英人才。', '1', '1', '1', '/Dentist_UPLOAD/image/art_thumbnail/20181014210503_hj2.jpg');
...
INSERT INTO `t_article` VALUES ('23', 'Test', '测试', 'ARTICLE_NEWS', '2018-10-14 20:48:29', '《阳光灿烂的日子》，改编自王朔的小说《动物凶猛》，1994年最受中国人关注的一部国产电影，姜文的导演处女作。', '1', '1', '1', '');
INSERT INTO `t_article` VALUES ('27', '111', '111', 'ARTICLE_YH_ACTIVITY', '2018-10-11 22:12:47', '优惠', '0', '1', '1', '/Dentist_UPLOAD/image/art_thumbnail/20181011221242_equip2.jpg');
INSERT INTO `t_article` VALUES ('28', '33', '333', 'ARTICLE_YH_ACTIVITY', '2018-10-14 20:49:18', '333', '0', '1', '1', '/Dentist_UPLOAD/image/art_thumbnail/20181014204915_hj3.jpg');
INSERT INTO `t_article` VALUES ('29', 'qqqq', '111', 'ARTICLE_NEWS', '2018-10-14 20:51:54', '1111', '0', '1', '1', '');
...
INSERT INTO `t_article_ext` VALUES ('18', '27', '优惠', '12');
INSERT INTO `t_article_ext` VALUES ('19', '28', '3333', '16');
INSERT INTO `t_article_ext` VALUES ('20', '29', '1111111111111', '2');
...
CREATE TABLE `t_banner` (
  ...
  `content` text COMMENT '（轮播banner）活动内容',
  `readValue` int(7) DEFAULT NULL COMMENT '阅读量',
  `createTime` date NOT NULL COMMENT '时间',
  PRIMARY KEY (`id`)
...
-- Records of t_banner
-- ----------------------------
INSERT INTO `t_banner` VALUES ('10', 'hj1', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180715190858_hj1.jpg', '1', '', null, null, '2018-11-05');
INSERT INTO `t_banner` VALUES ('11', 'hj2', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180715190920_hj2.jpg', '1', '', null, null, '2018-11-06');
INSERT INTO `t_banner` VALUES ('12', 'hj3', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180715190937_hj3.jpg', '1', '', null, null, '2018-11-14');
INSERT INTO `t_banner` VALUES ('13', 'hj4', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180715190957_hj4.jpg', '1', '', null, null, '2018-10-30');
INSERT INTO `t_banner` VALUES ('14', 'hj5', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180715191011_hj5.jpg', '1', '', null, null, '2018-11-22');
INSERT INTO `t_banner` VALUES ('15', 'hj6', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180715191027_hj6.jpg', '1', '', null, null, '2018-11-14');
INSERT INTO `t_banner` VALUES ('16', 'shebei1', 'BANNER_FACILITY', '/Dentist_UPLOAD/image/banner/20180715191051_equip.jpg', '1', '', null, null, '2018-11-14');
INSERT INTO `t_banner` VALUES ('17', 'shebei2', 'BANNER_FACILITY', '/Dentist_UPLOAD/image/banner/20180715191109_equip2.jpg', '1', '', null, null, '2018-11-06');
INSERT INTO `t_banner` VALUES ('18', 'shebie3', 'BANNER_FACILITY', '/Dentist_UPLOAD/image/banner/20180715191130_equip3.jpg', '1', '', null, null, '2018-11-13');
INSERT INTO `t_banner` VALUES ('19', 'shebei4', 'BANNER_FACILITY', '/Dentist_UPLOAD/image/banner/20180715191224_equip4.jpg', '1', '', null, null, '2018-11-21');
INSERT INTO `t_banner` VALUES ('20', 'shebei5', 'BANNER_FACILITY', '/Dentist_UPLOAD/image/banner/20180715191240_equip5.jpg', '1', '', null, null, '2018-11-14');
INSERT INTO `t_banner` VALUES ('21', 'shebei6', 'BANNER_FACILITY', '/Dentist_UPLOAD/image/banner/20180715191255_equip6.jpg', '1', '', null, null, '2018-11-13');
INSERT INTO `t_banner` VALUES ('22', 'honor1', 'BANNER_HOROR', '/Dentist_UPLOAD/image/banner/20180715191315_honor2.png', '1', '', null, null, '2018-11-27');
INSERT INTO `t_banner` VALUES ('23', 'honor2', 'BANNER_HOROR', '/Dentist_UPLOAD/image/banner/20180715191335_honor3.png', '1', '', null, null, '2018-11-14');
INSERT INTO `t_banner` VALUES ('24', 'honor3', 'BANNER_HOROR', '/Dentist_UPLOAD/image/banner/20180715191351_honor4.png', '1', '', null, null, '2018-11-27');
INSERT INTO `t_banner` VALUES ('25', 'honor4', 'BANNER_HOROR', '/Dentist_UPLOAD/image/banner/20180715191409_honor5.png', '1', '', null, null, '2018-10-30');
INSERT INTO `t_banner` VALUES ('26', 'honor5', 'BANNER_HOROR', '/Dentist_UPLOAD/image/banner/20180715191424_honor6.png', '1', '', null, null, '2018-11-20');
INSERT INTO `t_banner` VALUES ('27', 'honor6', 'BANNER_HOROR', '/Dentist_UPLOAD/image/banner/20180715191438_honor7.png', '1', '', null, null, '2018-11-21');
INSERT INTO `t_banner` VALUES ('28', '轮播图1', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20180715201944_banner.jpg', '0', '', null, null, '2018-11-06');
INSERT INTO `t_banner` VALUES ('29', 'lunbo', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20181011230550_春节banner-压缩.jpg', '1', '', null, null, '2018-11-12');
INSERT INTO `t_banner` VALUES ('30', '轮播3', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20180715202016_banner2.jpg', '0', '', null, null, '2018-11-19');
INSERT INTO `t_banner` VALUES ('31', 'lunbo4', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20180715202039_banner3.jpg', '1', '', null, null, '2018-11-06');
INSERT INTO `t_banner` VALUES ('32', 'lunbo5', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20181011221627_banner5.jpg', '1', '', null, null, '2018-11-14');
INSERT INTO `t_banner` VALUES ('33', 'lunbo6', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20180715202115_banner4.jpg', '1', '', null, null, '2018-11-13');
INSERT INTO `t_banner` VALUES ('34', '马连洼店', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180716230228_马连洼店.png', '1', '', null, null, '2018-11-20');
INSERT INTO `t_banner` VALUES ('35', '马连洼前台', 'BANNER_ENVIRONMENT', '/Dentist_UPLOAD/image/banner/20180716230252_马连洼前台.png', '1', '', null, null, '2018-11-12');
INSERT INTO `t_banner` VALUES ('39', '55555', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20181101221108_春节banner-压缩.jpg', '1', '/activity/showContentById?acId=39', '<p style=\"text-align: center;\"><span style=\"font-size: 18px;\">新北口腔新年钜惠</span></p><p style=\"text-align: center;\"><span style=\"font-size: 18px;\"><br></span></p><p style=\"text-align: center;\"><span style=\"font-size: 18px;\"><img src=\"/Dentist_UPLOAD/kindeditor_files/image/20181101/20181101221341_68.jpg\" alt=\"\"><br></span></p>', '7', '2018-11-04');
INSERT INTO `t_banner` VALUES ('40', '55555', 'BANNER_LUNBO', '/Dentist_UPLOAD/image/banner/20181104174634_banner3.jpg', '1', '/activity/showContentById?acId=40', '<img src=\"http://localhost:8091/kindeditor/plugins/emoticons/images/28.gif\" alt=\"\" border=\"0\">', '13', '2018-11-04');
...
CREATE TABLE `t_doctor` (
  ...
  `clinic` varchar(30) DEFAULT NULL COMMENT '所在门诊',
  `point` int(11) DEFAULT NULL COMMENT '评分',
  ...
  `inchPhotoPath` varchar(150) DEFAULT NULL COMMENT '一寸照',
...
-- Records of t_doctor
-- ----------------------------
INSERT INTO `t_doctor` VALUES ('1', '邓兰', '本科', '北京大学', '1111', 'CLINIC_YM', '20', '原上海九院种植修复专家#数万例种植牙手术成功经验', 'PRACTICE_PHYSICIAN', '根管治疗，牙齿冷光美白', '/Dentist_UPLOAD/image/doctor_pic/20181011222919_equip4.jpg', '/Dentist_UPLOAD/image/doctor_inchphoto/20180725223644_证件照.jpg', '2018-10-22 21:32:56');
INSERT INTO `t_doctor` VALUES ('2', '张三', '', '', '修复科主任', 'CLINIC_YM', '21', '曾多次获得全国病例大赛第一名#111#在核心期刊顶尖专业杂志发表论文#多次参加国内正畸会议并大会发言', 'ATTENDING_PHYSICIAN', '111111', '/Dentist_UPLOAD/image/doctor_pic/20180812174042_hj5.jpg', '/Dentist_UPLOAD/image/doctor_inchphoto/20180812174814_xzj9.jpg', '2018-09-21 19:53:14');
INSERT INTO `t_doctor` VALUES ('3', '晓红', '', '', '牙齿治疗顾问', 'CLINIC_YM', '20', '对青少年矫正及传统矫正深有研究#多次参加国际口腔正畸专业会议并接受培训#上海著名青少年牙齿矫正专家', 'PRACTICE_PHYSICIAN', '牙齿美白，根管治疗等', '/Dentist_UPLOAD/image/doctor_pic/20181021193100_xzj9.jpg', '/Dentist_UPLOAD/image/doctor_inchphoto/20181021193051_xzj9.jpg', '2018-10-21 19:31:03');
...
INSERT INTO `t_menu` VALUES ('2', '宣传管理', '文章和Banner', null, null, null, '2018-06-15 17:17:43', '1');
...
INSERT INTO `t_menu` VALUES ('15', '问答管理', '前台问答', '2', '/admin/qa/toQas', null, '2018-09-17 09:26:31', '1');
INSERT INTO `t_menu` VALUES ('16', '患者中心', '患者管理', null, null, null, '2018-09-18 09:57:15', '1');
INSERT INTO `t_menu` VALUES ('17', '预约管理', '预约', '16', '/admin/appoint/toAppoints', null, '2018-09-18 09:59:42', '1');
...
CREATE TABLE `t_qa` (
  ...
  `answer` varchar(500) NOT NULL COMMENT '回答',
  `operatorId` int(11) NOT NULL COMMENT '操作员ID',
...
-- Records of t_qa
-- ----------------------------
INSERT INTO `t_qa` VALUES ('1', '刷牙可以是牙齿变白么？', '写影评，应该把握好这样几点：捕捉住感受点。一部电影涉及的方面很广，需要品评的着笔点很多。这就需要对电影反这就需要对电影反这就需要对电影反这就需要对电影反', '1', '2018-09-17');
INSERT INTO `t_qa` VALUES ('3', '1111111？', '写影评，应该把握好这样几点：捕捉住感受点。一部电影涉及的方面很广，需要品评的着笔点很多。这就需要对电影反', '1', '2018-09-17');
INSERT INTO `t_qa` VALUES ('4', '11', '写影评，应该把握好这样几点：捕捉住感受点。一部电影涉及的方面很广，需要品评的着笔点很多。这就需要对电影反', '1', '2018-09-17');
INSERT INTO `t_qa` VALUES ('5', '333333333333？？', '写影评，应该把握好这样几点：捕捉住感受点。一部电影涉及的方面很广，需要品评的着笔点很多。这就需要对电影反', '1', '2018-09-17');
