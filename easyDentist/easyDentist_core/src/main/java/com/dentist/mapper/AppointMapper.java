...
public interface AppointMapper {
	...
	int queryApponitPageCountByMessageTypeAndPatientNameAndPhone(
			@Param("messageType") String messageType,@Param("status") String status, @Param("patientName") String patientName,@Param("phone") String phone);

	
	List<Appoint> queryAppointPageInfoByMessageTypeAndPatientNameAndPhone(
			@Param(value="start") Integer start,@Param(value="size") Integer size,@Param("messageType") String messageType,
			@Param("status") String status, @Param("patientName") String patientName,@Param("phone") String phone);
}